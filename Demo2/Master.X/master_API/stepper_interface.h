...
extern volatile uint16_t ms1; // Used to count number of ms11
extern volatile uint16_t step; // Used in the timer to count number of steps taken
extern volatile uint16_t cur_pos; // The current relative position of stepper motor shaft
extern volatile uint16_t prev_pos;
