...
SOURCEFILES_QUOTED_IF_SPACED=master_API/adc1.c master_API/pwm_interface.c master_API/uart1.c master_API/stepper_interface.c master_API/uart_printf.c master_API/init_master_api.c master_API/tmr1.c mcc_generated_files/traps.c mcc_generated_files/system.c mcc_generated_files/slave1.c mcc_generated_files/clock.c mcc_generated_files/reset.c mcc_generated_files/mcc.c mcc_generated_files/ext_int.c mcc_generated_files/pin_manager.c mcc_generated_files/pwm.c mcc_generated_files/interrupt_manager.c main.c /Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/${IMAGE_TYPE}/Slave.s 

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/master_API/adc1.o ${OBJECTDIR}/master_API/pwm_interface.o ${OBJECTDIR}/master_API/uart1.o ${OBJECTDIR}/master_API/stepper_interface.o ${OBJECTDIR}/master_API/uart_printf.o ${OBJECTDIR}/master_API/init_master_api.o ${OBJECTDIR}/master_API/tmr1.o ${OBJECTDIR}/mcc_generated_files/traps.o ${OBJECTDIR}/mcc_generated_files/system.o ${OBJECTDIR}/mcc_generated_files/slave1.o ${OBJECTDIR}/mcc_generated_files/clock.o ${OBJECTDIR}/mcc_generated_files/reset.o ${OBJECTDIR}/mcc_generated_files/mcc.o ${OBJECTDIR}/mcc_generated_files/ext_int.o ${OBJECTDIR}/mcc_generated_files/pin_manager.o ${OBJECTDIR}/mcc_generated_files/pwm.o ${OBJECTDIR}/mcc_generated_files/interrupt_manager.o ${OBJECTDIR}/main.o ${OBJECTDIR}/Slave.o 
...
# Source Files
SOURCEFILES=master_API/adc1.c master_API/pwm_interface.c master_API/uart1.c master_API/stepper_interface.c master_API/uart_printf.c master_API/init_master_api.c master_API/tmr1.c mcc_generated_files/traps.c mcc_generated_files/system.c mcc_generated_files/slave1.c mcc_generated_files/clock.c mcc_generated_files/reset.c mcc_generated_files/mcc.c mcc_generated_files/ext_int.c mcc_generated_files/pin_manager.c mcc_generated_files/pwm.c mcc_generated_files/interrupt_manager.c main.c /Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/${IMAGE_TYPE}/Slave.s 
...
${OBJECTDIR}/master_API/tmr1.o: master_API/tmr1.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/master_API" 
	@${RM} ${OBJECTDIR}/master_API/tmr1.o.d 
	@${RM} ${OBJECTDIR}/master_API/tmr1.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  master_API/tmr1.c  -o ${OBJECTDIR}/master_API/tmr1.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/master_API/tmr1.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -I"/Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/production"  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/master_API/tmr1.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  main.c  -o ${OBJECTDIR}/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/main.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -I"/Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/production"  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Slave.o: /Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/${IMAGE_TYPE}/Slave.s  nbproject/Makefile-${CND_CONF}.mk
	${MP_CC} -c -mcpu=$(MP_PROCESSOR_OPTION)  /Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/${IMAGE_TYPE}/Slave.s  -o ${OBJECTDIR}/Slave.o
else
${OBJECTDIR}/Slave.o: /Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/${IMAGE_TYPE}/Slave.s  nbproject/Makefile-${CND_CONF}.mk
	${MP_CC} -c -mcpu=$(MP_PROCESSOR_OPTION)  /Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/${IMAGE_TYPE}/Slave.s  -o ${OBJECTDIR}/Slave.o
endif
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Master.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_Library.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mx_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_mzef.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_Library.X.a /Applications/microchip/xc16/v1.36/lib/libq-elf.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Master.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_Library.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mx_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_mzef.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_Library.X.a /Applications/microchip/xc16/v1.36/lib/libq-elf.a  -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG=__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -I"/Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/production"   -mreserve=data@0x1000:0x101B -mreserve=data@0x101C:0x101D -mreserve=data@0x101E:0x101F -mreserve=data@0x1020:0x1021 -mreserve=data@0x1022:0x1023 -mreserve=data@0x1024:0x1027 -mreserve=data@0x1028:0x104F   -Wl,--local-stack,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D__DEBUG=__DEBUG,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Master.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_Library.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mx_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_mzef.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_Library.X.a /Applications/microchip/xc16/v1.36/lib/libq-elf.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Master.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_Library.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mx_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/libq_c_mips32_mz_l.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_C_mzef.a ../../../microchip/harmony/v2_06/bin/framework/math/libq/LIBQ_Library.X.a /Applications/microchip/xc16/v1.36/lib/libq-elf.a  -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -I"/Users/victorsira/MPLABXProjects/Demo3/Slave.X/dist/default/production"  -Wl,--local-stack,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
